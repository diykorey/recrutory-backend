 ...
 */
kandidatoApp.controller('listCtrl', function($scope, $rootScope, $log, ApiDataFactory, $timeout) {
    ...
    $scope.selectVacancy = function(vacancy) {
        ...
        if ($scope.currentVacancy && vacancy.id === $scope.currentVacancy.id) {
