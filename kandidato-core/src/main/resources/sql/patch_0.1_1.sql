...
CREATE TABLE `VACANCIES_TAGS` (
  ...
  FOREIGN KEY (VACANCY_ID)
  REFERENCES VACANCIES (VACANCY_ID) ON DELETE CASCADE
)
  ENGINE =InnoDB;
...
CREATE TABLE `RESUME` (
  ...
  STATE VARCHAR(20) NOT NULL,
  RESUME_OWNER_ID BIGINT(20) UNSIGNED NOT NULL,
  FOREIGN KEY (RESUME_OWNER_ID) REFERENCES PEOPLE (PERSON_ID) ON DELETE CASCADE,
