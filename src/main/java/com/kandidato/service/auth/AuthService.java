...
public class AuthService {
  ...
  public void login(HttpServletRequest request, HttpServletResponse response) throws URISyntaxException, IOException {
    ...
    String url = new URIBuilder("https://www.linkedin.com/uas/oauth2/authorization").setParameters(params).build().toString();
  ...
  public String auth(@RequestParam(value = "code", required = false) String code,
      @RequestParam(value = "state", required = true) String state, @RequestParam(value = "error", required = false) String error,
      @RequestParam(value = "error_description", required = false) String error_description, HttpServletRequest request,
